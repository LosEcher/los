...
type RunRoutesDependencies = {
  ...
  applyToolCallRecoveryTransitionForRunSpec: typeof applyToolCallRecoveryTransitionForRunSpec;
  ...
  listRunSpecs: typeof listRunSpecs;
  listSessionEventsSince: typeof listSessionEventsSince;
  listStreamCheckpointsSince: typeof listStreamCheckpointsSince;
  listWorkItemRunLinksForRunSpec: typeof listWorkItemRunLinksForRunSpec;
  loadRunSpec: typeof loadRunSpec;
  readAgentTaskGraph: typeof readAgentTaskGraph;
  readRunStateProjection: typeof readRunStateProjection;
  readRuntimeEvidenceGraph: typeof readRuntimeEvidenceGraph;
  readToolCallRecoveryForRunSpec: typeof readToolCallRecoveryForRunSpec;
  recordWorkerAnswer: typeof recordWorkerAnswer;
...
const defaultDependencies: RunRoutesDependencies = {
  appendSessionEvent,
  applyToolCallRecoveryTransitionForRunSpec,
  approveRunSpecPhase,
  cancelScheduledTask,
