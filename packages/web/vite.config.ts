...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      '/scheduled-work-items': 'http://127.0.0.1:8080',
      '/scheduled-work-item-runs': 'http://127.0.0.1:8080',
