...
const BACKLOG_CASES: EvalBacklogCase[] = [
  { caseId: 'E01', name: 'Dirty Worktree Formatter', hasProbe: true, probeFile: 'eval-probes.test.ts' },
  ...
  { caseId: 'E05', name: 'Git Detached Head In A jj Repo', hasProbe: true, probeFile: 'eval-probes.test.ts' },
  { caseId: 'E06', name: 'Todo Done Without Execution Evidence', hasProbe: true, probeFile: 'eval-probes.test.ts' },
  { caseId: 'E07', name: 'Legacy Repo As Active Target', hasProbe: true, probeFile: 'eval-probes.test.ts' },
  ...
  { caseId: 'E10', name: 'Flattened Provider Truth', hasProbe: true, probeFile: 'eval-probes.test.ts' },
  ...
  { caseId: 'E14', name: 'Run Spec Missing Operator Contract', hasProbe: true, probeFile: 'run-contract.test.ts' },
  { caseId: 'E15', name: 'Tool Event Without Recoverable State', hasProbe: true, probeFile: 'execution-transitions.test.ts' },
  { caseId: 'E16', name: 'Verification Claim Without State', hasProbe: true, probeFile: 'run-contract.test.ts' },
