...
export const AUDIT_BASELINE_P2_TODO_SEED: CreateTodoInput[] = [
...

  {
    ...
    metadata: {
      ...
      evidence: 'pg_stat_user_tables: file_sync_entries is largest at about 55,520 rows and 89,653,248 bytes; session_events about 8,829 rows and 11,386,880 bytes.',
    },
  },
  {
    ...
    metadata: {
      needsExternalInfo: false,
      observedAt: '2026-07-16',
      evidence: '30-day provider_compat_evidence contained three rows: DeepSeek pass, one eval fixture pass, and xAI failure; sample volume is insufficient for promotion decisions.',
    },
  },
  {
  ...
  },
  {
    ...
    metadata: {
      needsExternalInfo: false,
      observedAt: '2026-07-16',
      evidence: 'Three online executors (macOS local, node34 Linux, Oracle Linux) reported fresh heartbeat, run_agent=true, and verified agent_http/NDJSON connectivity; historical Windows and retired entries were offline.',
    },
  },
  {
    ...
    metadata: {
      needsExternalInfo: false,
      observedAt: '2026-07-16',
      evidence: 'No OTEL_* process variables or .env/.env.example collector endpoint were configured. The los local OTel bridge remains the only current ingest path.',
    },
  },
  {
