...
export const SEED_JOBS: CreateGovernanceJobInput[] = [
  {
    ...
    autoFix: {
      ...
      stopCondition: 'consecutive 2 sweeps with 0 seedOnly and 0 statusDrift; DB-only todos are preserved',
  ...
  },
  {
    ...
    autoFix: {
      ...
      stopCondition: 'no unacknowledged lease-expired dead-letter event remains requeue-eligible',
