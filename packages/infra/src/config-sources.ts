...
const ENV_MAP: [string, string][] = [
  ...
  ['LOS_SKILLS_RUNTIME', 'agent.skills.runtimeEnabled'],
  ['LOS_SKILLS_AUTO', 'agent.skills.autoInject'],
  ['LOS_SKILLS_MAX_AUTO', 'agent.skills.maxAutoSkills'],
  ['LOS_SKILLS_MAX_TOKENS', 'agent.skills.maxSkillTokens'],
  ['LOS_OPERATOR_RULES_INJECT', 'agent.rules.operatorInject'],
  ['LOS_OPERATOR_RULES_ENFORCE', 'agent.rules.enforcementEnabled'],
  ['LOS_OPERATOR_RULES_MAX', 'agent.rules.maxPromptRules'],
